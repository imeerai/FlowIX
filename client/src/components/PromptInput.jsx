...
import { ArrowRight, CloudUpload, Loader2, Mic } from "lucide-react";
...
const PromptInput = ({
  ...
  if (variant === "glass") {
    return (
      ...
      >
        ...
        />
        <div className="flex items-center justify-between pb-3 gap-2 px-3 ">
          <label
            htmlFor="file"
  ...
  return (
    ...
    >
      ...
      >
        {loading ? (
          <Loader2 size={large ? 20 : 15} className="animate-spin" />
        ) : (
          <ArrowRight size={18} />
        )}
      </button>
